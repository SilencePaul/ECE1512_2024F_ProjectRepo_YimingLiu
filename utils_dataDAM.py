...
from networks_dataDAM import MLP, ConvNet, LeNet, AlexNet, AlexNetBN, VGG11, VGG11BN, ResNet18, ResNet18BN_AP, ResNet18BN, ViTModel
import tqdm
import kornia as K
...
def get_eval_pool(eval_mode, model, model_eval):
    if eval_mode == 'M': # multiple architectures
        model_eval_pool = ['ConvNet', 'ResNet18', 'AlexNet', 'VGG11']
