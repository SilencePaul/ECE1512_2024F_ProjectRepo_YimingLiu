...
def main():
    ...
    # Base on Table 1, we use 10 images per class
    ...
    parser.add_argument('--save_path', type=str, default='./mnist_result_DataDAM_noise', help='path to save results')
