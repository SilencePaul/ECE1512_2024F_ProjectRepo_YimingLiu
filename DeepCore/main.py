...
def main():
    ...
    parser.add_argument('--model', type=str, default='CovnetD3', help='model')
    ...
    parser.add_argument('--fraction', default=1, type=float, help='fraction of data to be selected (default: 0.1)')
    ...
    # Selecting
    parser.add_argument("--selection_epochs", "-se", default=1, type=int,
