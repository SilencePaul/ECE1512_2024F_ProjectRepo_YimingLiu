...
from utils_dataDAM import get_loops, get_dataset, get_network, get_eval_pool, evaluate_synset, get_daparam, get_time, TensorDataset, epoch, DiffAugment, ParamDiffAug, get_attention
...
def main():
    ...
    # Use the ConvNet-3 model
    parser.add_argument('--model', type=str, default='ConvNetD3', help='model')
    # Base on Table 1, we use 50 images per class
    ...
    parser.add_argument('--save_path', type=str, default='./mhist_result_DataDAM_32_noise', help='path to save results')
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, testloader, zca = get_mhist_dataset(args.data_path)
